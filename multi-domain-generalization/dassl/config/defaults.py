...
_C.TRAINER.CONSTSTYLE.ALPHA_TRAIN = 0.5
_C.TRAINER.CONSTSTYLE.ALPHA_TEST = 0.5
...
#TAFCAL
_C.TRAINER.TAFCAL = CN()
_C.TRAINER.TAFCAL.MIX_AMP_RATIO = 0.5
_C.TRAINER.TAFCAL.WARM_UP_EPOCH = 20
_C.TRAINER.TAFCAL.KEEP_UPDATE_AMP_MEAN = 1
_C.TRAINER.TAFCAL.SWAP_AMP_RATIO = 0.3
_C.TRAINER.TAFCAL.CALIBRATE_ALPHA = -1
_C.TRAINER.TAFCAL.MIXUP_AMP_FEATURES = 1
_C.TRAINER.TAFCAL.MIXUP_ALPHA = 0.2
_C.TRAINER.TAFCAL.MIX_FUNC_RATIO = 0.3
_C.TRAINER.TAFCAL.TEST_AMP_FACTOR = 0.5